    ...
    tools: [
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            status: { type: "string" as const, description: "Filter by order status (e.g. paid, fulfilled, cancelled)" },
            limit: { type: "number" as const, description: "Number of orders to return (default 50)" },
          },
        },
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            order_id: { type: "string" as const, description: "The UUID of the order" },
            tracking_number: { type: "string" as const, description: "Shipment tracking number" },
            tracking_company: { type: "string" as const, description: "Shipping carrier name" },
            tracking_url: { type: "string" as const, description: "URL to track the shipment" },
            send_email: { type: "boolean" as const, description: "Send fulfillment email to customer (default true)" },
          },
          required: ["order_id"],
        },
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            order_id: { type: "string" as const, description: "The UUID of the order" },
            amount: { type: "number" as const, description: "Partial refund amount (omit for full refund)" },
            reason: { type: "string" as const, description: "Reason for the refund" },
            note: { type: "string" as const, description: "Internal note about this refund" },
          },
          required: ["order_id"],
        },
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            variant_id: { type: "string" as const, description: "The UUID of the variant" },
            sku: { type: "string" as const, description: "The SKU of the product/variant" },
            product_id: { type: "string" as const, description: "The UUID of the product" },
          },
        },
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            variant_id: { type: "string" as const, description: "The UUID of the variant" },
            quantity: { type: "number" as const, description: "Quantity value to set or adjust by" },
            mode: { type: "string" as const, enum: ["set", "adjust"], description: "'set' to replace quantity, 'adjust' to add/subtract" },
            reason: { type: "string" as const, description: "Reason for the inventory change" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            contact_id: { type: "string" as const, description: "The UUID of the contact" },
          },
          required: ["contact_id"],
        },
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            contact_id: { type: "string" as const, description: "The UUID of the contact" },
            points: { type: "number" as const, description: "Number of points to redeem" },
            order_id: { type: "string" as const, description: "The UUID of the order to apply the redemption to" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            limit: { type: "number" as const, description: "Number of gift cards to return (default 50)" },
          },
        },
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            initial_value: { type: "number" as const, description: "Initial monetary value of the gift card" },
            currency: { type: "string" as const, description: "Currency code (default EUR)" },
            code: { type: "string" as const, description: "Custom gift card code (auto-generated if omitted)" },
            expires_at: { type: "string" as const, description: "Expiration date (ISO 8601)" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            code: { type: "string" as const, description: "The gift card code" },
            amount: { type: "number" as const, description: "Amount to redeem from the gift card" },
            order_id: { type: "string" as const, description: "The UUID of the order to apply the redemption to" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            subscription_id: { type: "string" as const, description: "The UUID of the subscription" },
            action: { type: "string" as const, enum: ["delay", "ship_now"], description: "Action to perform" },
            target_date: { type: "string" as const, description: "New target date for delay action (ISO 8601)" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            approval_id: { type: "string" as const, description: "The UUID of the approval" },
          },
      ...
      },
      {
        ...
        inputSchema: {
          ...
          properties: {
            approval_id: { type: "string" as const, description: "The UUID of the approval" },
            reason: { type: "string" as const, description: "Reason for rejecting the approval" },
          },
          required: ["approval_id"],
        },
      },
      {
        ...
        inputSchema: {
          type: "object" as const,
          properties: {
            address: { type: "string" as const, description: "The address to geocode" },
          },
          required: ["address"],
        },
      },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  try {
    ...
    if (name === "add_to_cart") {
      ...
      if (typeof cart_id !== "string") throw new Error("cart_id must be a string");
    ...
    if (name === "fulfill_order") {
      const order_id = args?.order_id;
      if (typeof order_id !== "string") throw new Error("order_id must be a string");
    ...
    if (name === "get_inventory") {
      const params = new URLSearchParams();
      if (typeof args?.variant_id === "string") params.set("variant_id", args.variant_id);
      if (typeof args?.sku === "string") params.set("sku", args.sku);
      if (typeof args?.product_id === "string") params.set("product_id", args.product_id);
    ...
    if (name === "get_loyalty_balance") {
      ...
      if (typeof contact_id !== "string") throw new Error("contact_id must be a string");
    ...
    if (name === "create_gift_card") {
      ...
      if (typeof initial_value !== "number") throw new Error("initial_value must be a number");
    ...
    if (name === "update_subscription") {
      ...
      if (typeof args?.target_date === "string") body.target_date = args.target_date;
    ...
    if (name === "execute_approval") {
      ...
      if (typeof approval_id !== "string") throw new Error("approval_id must be a string");
