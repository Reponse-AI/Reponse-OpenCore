...
function ReponseProvider({
  ...
  const client2 = (0, import_react.useMemo)(
    () => new Reponse(options),
    [options.apiKey, options.baseUrl]
  );
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReponseContext.Provider, { value: client2, children });
}
function useReponse() {
  const client2 = (0, import_react.useContext)(ReponseContext);
  if (!client2) {
